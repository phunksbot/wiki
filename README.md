...
To better understand CryptoPhunks, start by reading about [Conceptual Art](https://en.wikipedia.org/wiki/Conceptual\_art),[ Marcel Duchamp](https://en.wikipedia.org/wiki/Marcel\_Duchamp), [Dadaism](https://en.wikipedia.org/wiki/Dada), [Andy Warhol](https://en.wikipedia.org/wiki/Andy\_Warhol) and [Memetics](https://en.wikipedia.org/wiki/Memetics). To many, the essence of Phunks comes more than the visual art itself. The simple transformational flip on the y axis ultimately blurs the lines between crypto, conceptual art, [performance art](https://en.wikipedia.org/wiki/Performance\_art) and traditional art. Phunks are often times used as idealogical status symbols by many ardent collectors.
