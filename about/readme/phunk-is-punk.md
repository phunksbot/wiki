...
**Since then, Phunk community continued to** [**build, innovate, pioneer**](../../resources/open-sourced.md) **and attract many developers interested in building in true decentralized Crypto environment where anyone with any skillset can grow, be inspired and supported by community of builders.**
